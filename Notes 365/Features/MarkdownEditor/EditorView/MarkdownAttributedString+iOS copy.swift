...
//    private func preparedTextStorage(width: String) -> NSTextStorage? {
//
...
//        return textStorage
        ...
        // Creates and configures a text storage which matches with the UILabel's configuration.
        let layoutManager = LayoutManager()
        let textContainer = NSTextContainer(size: CGSize(width: 600, height: 2000))
        textContainer.lineFragmentPadding = 0
...
//        boldFont = UIFont.boldSystemFont(ofSize: boldFont.pointSize)
    ...
    func canPocessCodeBlock(_ extendedRange: NSRange, _ innerAttributedString: NSMutableAttributedString) -> (Int, Bool) {
...
//        return false
    ...
    func processCodeBlock(extendedRange: NSRange, textStorage innerAttributedString: NSMutableAttributedString) {
        ...
        let (count, canProceed) = canPocessCodeBlock(extendedRange, innerAttributedString)
