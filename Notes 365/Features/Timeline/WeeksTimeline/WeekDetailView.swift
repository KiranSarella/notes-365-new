...
struct WeekDetailView: View {
    ...
    @Binding var weekState: TimelineDetailState
        ...
        VStack {
            HStack {
                ...
                if UIDevice.current.userInterfaceIdiom == .phone {
                    Text(weekTimeline.timelineIndex.date.formatted(date: .abbreviated, time: .omitted))
                        .listRowSeparator(.hidden)
                        .padding(.horizontal)
                        .font(.largeTitle)
                } else {
                    Text(weekTimeline.timelineIndex.date.formatted(date: .complete, time: .omitted))
                        .listRowSeparator(.hidden)
                        .padding(.horizontal)
                        .font(.largeTitle)
                }
