//
//  NotebooksContentSync.swift
//  Notes 365
//
//  Created by Kiran Sarella on 21/04/23.
//

import Foundation

class NotebooksContentSync {
    ...
    func initialGatheringSync() {
        ...
        // define predicate
        let folderPath = basePathURL.appendingPathComponent(Constants.notebooksFolderName).path(percentEncoded: false)
